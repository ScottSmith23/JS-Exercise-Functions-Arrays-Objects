 ...
 * }
*/
function makePersonObject(in1, in2, in3) {
  let pObject = {
          id: in1,
          name: in2,
          email: in3
...
*/
function makeSmartPerson(nameIn){
  let newObject = {
      name: nameIn,
...
function getLastCarInfo(inventory) {
  const thecar = inventory[inventory.length - 1];
...
*/
function carMaker(odoIn) {
  let newObject = {
      odometer: odoIn,
      drive: function(distance){ 
        let newval = this.odometer + distance;
        this.odometer = newval;
